...
/* (TRIGGERS)__________________________________________________________________________________________________________________________________________________
    ...
    Um Trigger pode ser utilizado para: 
        ...
        • Geração de valores de colunas – por exemplo, gerar o valor total da 
          nota fiscal a cada inclusão, exclusão ou alteração de itens da nota
    ...
    CREATE OR REPLACE TRIGGER NOME_TRIGGER  → declarar o trigger
        BEFORE                              → tempo em que será disparado o evento – BEFORE OU AFTER
            ...
            OR
            DELETE OF NOME_COLUNA           → DML para a coluna que será alterada                
        ON NOME_TABELA                      → Tabela na qual o trigger será executado, relacionada em BEGIN
    ...
    Obs: Os  registros  especiais  :NEW  e  :OLD  armazenam  temporariamente  os  
        valores  do  último registro manipulado pelo SGBD:
         DML                  :OLD                    :NEW
...
Exemplo 1:____________________________________________________________________________
